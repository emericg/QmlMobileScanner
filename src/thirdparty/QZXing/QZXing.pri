...
qzxing_multimedia {
    ...
    QT += concurrent
    HEADERS += $$PWD/QZXingFilterVideoSink.h
    SOURCES += $$PWD/QZXingFilterVideoSink.cpp
}
...
qzxing_qml {
    ...
    HEADERS += $$PWD/QZXingImageProvider.h
    SOURCES += $$PWD/QZXingImageProvider.cpp
}
...
unix {
    ...
    QMAKE_CLEAN += -r pkgconfig lib$${TARGET}.prl
}
